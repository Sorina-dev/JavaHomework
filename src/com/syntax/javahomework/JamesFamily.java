...
public class JamesFamily {
	...
	public static void main(String[] args) {
		...
		general();
		System.out
				.println(" Mother's name is " + lastName + " " + mom.firstName + ", she is " + mom.age + " years old");
		System.out.println(" Father's name is " + lastName + " " + dad.firstName + ", he is " + dad.age + " years old");
		System.out.println(
				" Sister's name is " + lastName + " " + sister.firstName + ", she is " + sister.age + " years old");
		System.out.println(
				" Brother's name is " + lastName + " " + brother.firstName + ", he is " + brother.age + " years old");
